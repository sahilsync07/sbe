    ...
    >
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <button
            @click="$router.push('/')"
            class="w-8 h-8 flex items-center justify-center rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-colors shadow-sm active:scale-95 border border-white/20 mr-1"
            title="Back to Hub"
          >
...
const ONE_TOUCH_GROUPS = [
  { label: 'Paragon', brands: ['Max', 'PARAGON GENTS', 'Escoute'], defaultMinQty: 10 },
  { label: 'Paragon Ladies', brands: ['PARAGON LADIES'], defaultMinQty: 10 },
  { label: 'Eeken', brands: ['EEKEN'], defaultMinQty: 4 },
  { label: 'Cubix', brands: ['CUBIX', 'CUBIX 2'], defaultMinQty: 10 },
  { label: 'Florex', brands: ['Florex (Swastik)'], defaultMinQty: 10 },
  { label: 'Action', brands: ['ACTION'], defaultMinQty: 10 },
  { label: 'Reliance', brands: ['RELIANCE FOOTWEAR'], defaultMinQty: 10 },
  { label: 'Ajanta', brands: ['AJANTA'], defaultMinQty: 10 },
  {
  ...
  { label: 'Paralite', brands: ['PARALITE'], defaultMinQty: 10 },
  {
